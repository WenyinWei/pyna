"""Tests for pyna.control â?Functional Perturbation Theory module.
...
class TestDPmAxisymmetric:
    ...
    def test_det_one(self):
        """det(exp(2ÏA)) = exp(2ÏÂ·Tr(A)); for Tr(A)=0 this equals 1."""
...
class TestCycleShift:
    def test_formula(self):
        """Î´x_cyc = -Aâ»Â?Â· Î´g  (exact algebraic identity)."""
...
class TestTopologyController:
    ...
    def test_objective_decreases(self):
        """Optimised Î´I must reduce the objective below the zero-current value."""
        ...
        obj0 = (s_vec - t_vec) @ W @ (s_vec - t_vec)  # Î´I = 0
        obj1 = result.fun
