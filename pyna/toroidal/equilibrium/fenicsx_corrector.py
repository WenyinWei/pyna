"""
pyna/pyna/toroidal/equilibrium/fenicsx_corrector.py
===================================================
...
def fpt_fenicsx_beta_step(
    ...
    if r_eff_surfaces is not None:
        ...
        # ------------------------------------------------------------------
        # Original circular cross-section approximation
        # ------------------------------------------------------------------
    ...
    try:
        ...
        from pyna.toroidal.plasma_response.PerturbGS import solve_perturbed_gs_coupled
