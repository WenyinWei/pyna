...
CylindricalVectorField = CylindricalVectorField3D
CylindricalScalarField = CylindricalScalarField3D


def magnitude(v: CylindricalVectorField3D) -> np.ndarray:
    """Pointwise magnitude |V| = sqrt(VR² + VZ² + VPhi²)."""
    return np.sqrt(v.VR**2 + v.VZ**2 + v.VPhi**2)


def cross(v1: CylindricalVectorField3D, v2: CylindricalVectorField3D) -> CylindricalVectorField3D:
...
def divergence(v: CylindricalVectorField3D) -> CylindricalScalarField3D:
...
def directional_derivative_of_scalar(
    v: CylindricalVectorField3D, s: CylindricalScalarField3D
...
def directional_derivative_of_vector(
    v1: CylindricalVectorField3D, v2: CylindricalVectorField3D
