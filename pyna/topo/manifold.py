...
def grow_manifold_from_Xcycle_by_formula(R, Z, Phi, BR, BZ, BPhi, Xcycle_RZdiff, Xcycle_eig_theta, S_span, S_num:int, Phi_span, Phi_num:int, rev_eigvec=False, first_step=5e-5, max_step=1e-4):
