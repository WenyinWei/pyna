"""pyna.MCF.coils.accel — GPU/CPU-accelerated circular coil field computation.
...
try:
    ...
    warnings.warn(
        "CuPy not available; pyna.MCF.coils.accel will fall back to CPU.",
        stacklevel=2,
    )
...
def _analytic_coil_field_cpu(centers, radii, normals, currents, field_pts):
    """CPU fallback using scipy's elliptic integrals (pyna.MCF.coils.coil)."""
