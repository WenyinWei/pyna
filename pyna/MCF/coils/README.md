# `pyna.MCF.coils` — Vacuum Coil Fields

## Overview

`pyna.MCF.coils` provides:
...
```python
from pyna.MCF.coils.RMP import RMP_spectrum_2d, island_width_at_rational_surfaces
...
```python
from pyna.MCF.coils.base import CoilFieldSuperposition, CoilFieldScaled
