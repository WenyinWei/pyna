...
cl /std:c++17 /O2 /openmp /EHsc /MD /LD ^
   /I"C:\Users\Legion\AppData\Local\Programs\Python\Python313\Include" ^
   /I"C:\Users\Legion\AppData\Local\Programs\Python\Python313\Lib\site-packages\pybind11\include" ^
   /I"D:\Repo\pyna\cyna\include" ^
